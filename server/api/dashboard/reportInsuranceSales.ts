...
import { createInsuranceSales } from "~/server/database/repositories/askJackRespository";
...
export default eventHandler(async (event) => {
    ...
    const data: IInsuranceSalesPost = body.data

    return await createInsuranceSales(data, user.id)
})